package com.andreisingeleytsev.dayzguide.ui.screens.constructions_screens
...
@Composable
fun ConstructionScreen(navHostController: NavHostController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier
            ...
            if (isFirstScreen.value) Image(
                painter = painterResource(id = R.drawable.constr1),
                contentDescription = null,
                modifier = Modifier.fillMaxWidth(),
                contentScale = ContentScale.FillWidth
            ) else {
                Image(
                    painter = painterResource(id = R.drawable.constr2),
                    contentDescription = null,
                    modifier = Modifier.fillMaxWidth(),
                    contentScale = ContentScale.FillWidth
                )
